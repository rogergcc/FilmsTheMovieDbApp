# FilmsTheMovieDbApp
Android app demo in release section  https://github.com/rogergcc/FilmsTheMovieDbApp/releases/tag/1
...
- [Retrofit](https://square.github.io/retrofit/) - Library to fetch HTTP client API calls in
  Android.
